...
const Hero = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full overflow-hidden rounded-3xl [background-image:url(/hero.webp)] bg-cover bg-center [box-shadow:inset_0px_0px_40px_20px_rgba(0,0,0,0.75)] [mask:linear-gradient(90deg,transparent,white_30%,white_70%,transparent)]"></div>
      </motion.div>
      <motion.section
