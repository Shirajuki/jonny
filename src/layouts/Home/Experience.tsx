...
const Experience = () => {
  return (
    <section id="experience">
      ...
      />
      <ScrollingHeading heading="EXPERIENCE" wrap={[8, -80]} className="!translate-y-44" baseVelocity={-5} />

      <h2 className="text-center text-4xl font-bold pt-72 pb-8 tracking-wide opacity-0">Experience</h2>
